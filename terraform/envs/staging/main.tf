# per-account module wiring. mirrors envs/dev; copy edits over after dev lands.
...
module "observability" {
  ...
  # AMG SSO wiring is a console step. off in dev.
  # TODO: flip true for staging once SSO group is mapped.
...
# recovery_window_in_days=0 so destroy actually removes them on dev.
